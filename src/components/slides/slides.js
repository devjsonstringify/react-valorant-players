								...
								<Box position='relative'>
									...
									{voiceLine.mediaList.map(({ wave, id }) => (
										<Box
											key={id}
											sx={{
												display: isMobileDevices ? 'none' : 'block',
												position: 'absolute',
												top: '50%',
												left: 0,
												width: 'calc(100vw / 5)',
									...
									<Box
										sx={{
											position: isMobileDevices ? 'relative' : 'absolute',
											maxWidth: isMobileDevices ? '100%' : '21.875rem',
											top: isMobileDevices ? 'unset' : '5rem',
											right: isMobileDevices ? 'unset' : '0',
											zIndex: 1000,
										}}>
										<PlayerRole
										...
										<Box
											...
											<PlayerAbility abilities={mergeAgentsAbilities} />
										</Box>
									</Box>
								</Box>
							)}
